...
namespace OnlineRestaurant.Web.Areas.Foods.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderedFoodName,OrderDateTime,OrderedQuantity,FoodCategoryId,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderedFoodName,OrderDateTime,OrderedQuantity,FoodCategoryId,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();

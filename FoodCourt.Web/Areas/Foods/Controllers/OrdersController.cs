...
namespace FoodCourt.Web.Areas.Foods.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Order.Include(o => o.FoodCategory);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderedFoodName,OrderedQuantity,FoodCategoryId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderedFoodName,OrderedQuantity,FoodCategoryId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
